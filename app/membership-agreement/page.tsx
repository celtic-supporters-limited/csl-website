        ...
        <Container>
          <div className="max-w-[780px]">
            ...
            <VolSection number="1" title="Definition">
              <p>Volunteers may access limited personal data for specific tasks such as share tracing, member support or admin duties.</p>
            </VolSection>
            ...
            <VolSection number="4" title="Legal Basis">
              <p>Volunteers act under CSL&apos;s legitimate interest in providing services to members.</p>
            </VolSection>

            <VolSection number="5" title="Termination">
              <p>Access may be revoked at any time. Volunteers must delete all data immediately when access ends.</p>
            </VolSection>
          </div>
        </Container>
      </section>
...
function VolSection({ number, title, children }: { number: string; title: string; children: React.ReactNode }) {
  return (
    <div className="mb-8">
