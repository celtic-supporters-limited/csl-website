...
export default function ProxyPage() {
  return (
    <>
            ...
            {[
              {
                ...
                body: "Confirm your name, shareholding details, and email address in the form below.",
              },
              {
                num: 2,
                title: "We Send a Form",
                body: "CSL sends you the official Proxy Form naming Celtic Supporters Limited as your proxy holder.",
              },
              {
                num: 3,
                title: "Sign and Return",
                body: "Sign and return the form to Computershare by the stated deadline before the AGM.",
              },
              {
                num: 4,
                title: "We Vote for You",
                body: "CSL votes your shares on all resolutions in line with our published governance positions.",
              },
      ...
      {/* PROXY FORM */}
      <section id="assign" className="px-[5%] py-[72px]">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-[52px]">
            <span className="inline-block bg-csl-light text-csl-dark text-[0.78rem] font-semibold px-3 py-1 rounded-full uppercase tracking-wider mb-3">
              Assign Your Proxy
