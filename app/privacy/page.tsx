  ...
  return (
    <>
      ...
      <section className="px-[5%] py-[72px]">
        <div className="max-w-[780px] mx-auto prose-like">
          ...
          <Section number="4" title="Lawful Basis for Processing">
            <ul className="list-disc pl-5 space-y-2 text-gray-700 text-[0.95rem] leading-[1.75]">
              <li>
                <strong className="text-gray-900">Contract</strong> - to provide membership
                services, manage subscriptions, communicate operational updates and administer
                accounts.
              </li>
              <li>
                <strong className="text-gray-900">Consent</strong> - for marketing communications.
              </li>
              <li>
                <strong className="text-gray-900">Legitimate Interests</strong> - site security,
                fraud prevention, improving member experience, tracing lost shareholders, maintaining
                accurate membership records.
              </li>
              <li>
                <strong className="text-gray-900">Legal Obligation</strong> - keeping necessary
          ...
          <Section number="5" title="How We Use Your Data">
            <p>
              ...
              improve CSL&apos;s services, comply with legal duties, and deliver share tracing
              support.
            </p>
          ...
          <Section number="10" title="Children&apos;s Data">
            <p>
              We do not knowingly collect data from children under 16. Any such data will be
              deleted.
            </p>
          </Section>
