...
export default function ShareTracingPage() {
  return (
    <>
            ...
            {[
              {
                ...
                body: "Complete the form below with as much detail as you can about your potential holding.",
              },
              {
                num: 2,
                title: "Initial Review",
                body: "Our team reviews your enquiry and sends you a personalised guidance pack within 5 working days.",
              },
              {
                num: 3,
                title: "Letter of Authority",
                body: "If needed, we provide you with a Letter of Authority (LOA) to authorise CSL to act on your behalf with Computershare.",
              },
              {
                num: 4,
                title: "Resolution",
                body: "We work with Computershare to confirm your holding and guide you through your chosen next step - hold, sell, or proxy.",
              },
      ...
      {/* ENQUIRY FORM */}
      <section id="enquiry" className="bg-gray-50 px-[5%] py-[72px]">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-[52px]">
            <span className="inline-block bg-csl-light text-csl-dark text-[0.78rem] font-semibold px-3 py-1 rounded-full uppercase tracking-wider mb-3">
              Get Started
